    ...
    <div className="h-screen flex flex-col overflow-hidden bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-3xl font-display text-olympus-navy flex items-center gap-3">
            <CalendarIcon size={32} className="text-olympus-gold" />
            {t('weekPlanner')}
          </h1>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="px-4 py-2 bg-olympus-navy text-white rounded-lg hover:bg-olympus-navy/90 transition flex items-center gap-2"
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="text-lg font-semibold text-olympus-navy">
            ...
            <button
              ...
              className="ml-2 px-4 py-2 text-sm bg-olympus-gold text-white rounded-lg hover:bg-olympus-gold-light transition"
            >
              {t('today')}
            </button>
          </div>
